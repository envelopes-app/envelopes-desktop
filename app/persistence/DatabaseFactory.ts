...
export class DatabaseFactory {
		...
		var queryList:Array<IDatabaseQuery> = [
			...
			},
			{
				query: `CREATE TABLE IF NOT EXISTS 'MonthlyBudgets' (
						...
						'deferredIncome' NUMERIC NOT NULL DEFAULT 0,
						...
						'unpaidBudgetedSpending' NUMERIC NOT NULL DEFAULT 0,
						'calculationNotes' VARCHAR,
						'deviceKnowledge' NUMERIC NOT NULL)`,
				arguments: []
			},
			{
				query: `CREATE TABLE IF NOT EXISTS 'MonthlySubCategoryBudgets' (
						...
						'budgeted' NUMERIC NOT NULL DEFAULT 0,
						'overspendingHandling' VARCHAR,
						'note' VARCHAR,
						'cashOutflows' NUMERIC NOT NULL DEFAULT 0,
						'creditOutflows' NUMERIC NOT NULL DEFAULT 0,
						'balance' NUMERIC NOT NULL DEFAULT 0,
						'overspendingAffectsBuffer' BOOL NOT NULL DEFAULT 1,
						...
						'paymentAgainstBudgetedSpending' NUMERIC,
						'paymentForDebtReduction' NUMERIC,
						'allSpendingSinceLastPayment' NUMERIC,
						'budgetedSpendingSinceLastPayment' NUMERIC,
						'recommendedPayment' NUMERIC,
						'maximumPayment' NUMERIC,
						'upcomingTransactions' NUMERIC,
						'goalTarget' NUMERIC,
						'subCategoryInternalName' VARCHAR,
						'subCategorySortableIndex' NUMERIC,
						'subCategoryPinnedIndex' NUMERIC,
						'subCategoryType' VARCHAR,
						'subCategoryName' VARCHAR,
						'subCategoryNote' VARCHAR,
						'masterCategoryId' VARCHAR,
						'masterCategoryName' VARCHAR,
						'masterCategoryInternalName' VARCHAR,
						'masterCategorySortableIndex' NUMERIC,
						'deviceKnowledge' NUMERIC NOT NULL)`,
				arguments: []
			},
			{
	...
	private getRemoveDatabaseScripts():Array<IDatabaseQuery> {
		...
		var queryList:Array<IDatabaseQuery> = [
			...
			{query: "DROP TABLE IF EXISTS 'Users'", arguments: []},
			{query: "DROP TABLE IF EXISTS 'UserKnowledge'", arguments: []},
			...
			{query: "DROP TABLE IF EXISTS 'UserSettings'", arguments: []},
			{query: "DROP TABLE IF EXISTS 'UserBudgets'", arguments: []},
