...
export function insertDatabaseObject(dbObject:budgetEntities.IAccountMapping):IDatabaseQuery {
...
export function loadDatabaseObject(budgetId:string, deviceKnowledge:number):IDatabaseQuery {
...
export function getAllAccountMappings(budgetId:string, includeTombstonedEntities:boolean = false):IDatabaseQuery {
