export class InternalCategories {

	public static InternalMasterCategory:string         = "MasterCategory/__Internal__";
	public static HiddenMasterCategory:string           = "MasterCategory/__Hidden__";
...
export class InternalCategoryNames {

	public static InternalMasterCategory:string         = "Internal Master Category";
	public static HiddenMasterCategory:string           = "Hidden Categories";
